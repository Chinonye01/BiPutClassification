# -*- coding: utf-8 -*-
"""BidenAndPutinClassification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1p-RW2WzoREu6-umUYFcMbjGhrERbJmpG
"""
...
extract_path = '/content/BidPut'  # Specify the path to extract the contents

with zipfile.ZipFile(zip_path, 'r') as zip_ref:
    zip_ref.extractall(extract_path)

train_dir = '/content/BidPut/BidPut/train'
test_dir = '/content/BidPut/BidPut/train'
...
rand_images1 = random.sample(os.listdir("/content/BidPut/BidPut/train/biden"), 8)
rand_images2 = random.sample(os.listdir("/content/BidPut/BidPut/train/putin"), 8)

fig = plt.figure(figsize=(10, 10))
for i, im in enumerate(rand_images1):
    plt.subplot(2, 4, i+1)
    im = cv2.imread(os.path.join("/content/BidPut/BidPut/train/biden", im))
    plt.imshow(im)
    plt.axis('off')
...
for i, im in enumerate(rand_images2):
    plt.subplot(2, 4, i+1)
    im = cv2.imread(os.path.join("/content/BidPut/BidPut/train/putin", im))
    plt.imshow(im)
    plt.axis('off')
...
predict("/content/BidPut/BidPut/test/biden/00507_0.jpg", model)

predict("/content/BidPut/BidPut/test/putin/00503_0.jpg", model)